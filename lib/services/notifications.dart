...
const _kChannels = <AndroidNotificationChannel>[
  AndroidNotificationChannel('rate_alerts', 'Alertas de tasa',
      description: 'Picos y metas de tasa BCV/paralelo', importance: Importance.high),
  AndroidNotificationChannel('price_targets', 'Metas de precio',
      description: 'Productos que cruzan su meta', importance: Importance.high),
  AndroidNotificationChannel('reminders', 'Recordatorios',
      description: 'Registro diario de gastos', importance: Importance.defaultImportance),
  AndroidNotificationChannel('room_activity', 'Sala en vivo',
      description: 'Actividad de la lista compartida', importance: Importance.high),
  AndroidNotificationChannel('default', 'General',
      description: 'Avisos varios', importance: Importance.defaultImportance),
];
