          ...
          child: Padding(
            ...
            child: Column(
              ...
              children: [
                ...
                Text(
                  'Fusionar une por id y no toca tu carrito ni tus ajustes. '
                ...
                SizedBox(
                  ...
                  child: OutlinedButton.icon(
                    ...
                    label: const Text(
                      'Borrar todos los datos (conserva tablero)',
                    ),
                    onPressed: () {
                      showDialog<void>(
                        context: context,
                        builder: (ctx) => AlertDialog(
                          ...
                          content: const Text(
                            'Productos, compras, movimientos, lista y plantillas se '
  ...
  Future<void> _import(BuildContext context, {required bool merge}) async {
    ...
    if (!result.ok) {
      if (context.mounted) {
        showToast(
          context,
          result.error ?? 'Archivo respaldo inválido',
            ...
            child: Column(
              children: [
                ...
                ListTile(
                  ...
                  subtitle: const Text(
                    '13 pasos por toda la app, anclados a cada pantalla',
