              ...
              children: [
                Row(
                  children: [
                    ...
                    Stamp(
                      _granted ? 'concedido' : 'sin permiso',
                      color: _granted
                ...
                SwitchListTile(
                  ...
                  subtitle: Text(
                    'Vigila BCV y paralelo; cooldown 30 min por fuente',
                    ...
                    children: [
                      for (final e in spikeSensitivities.entries)
                        ChipTag(
                          ...
                          onTap: () =>
                              store.setSetting('spikeThreshold', e.value),
                        ),
                    ],
                  ),
                SwitchListTile(
                ...
                SwitchListTile(
                  ...
                  dense: true,
                  title: const Text(
                    'Recordatorio diario de precios',
                    style: TextStyle(fontSize: 13),
                  ),
                  subtitle: Text(
                ...
                Row(
                  children: [
                    Expanded(
                      child: Text(
                        'Brecha BCV↔paralelo > ${fmtNum(alerts.gapThreshold, decimals: 0)} %',
                ...
                Row(
                  children: [
                    Expanded(
                      child: Text(
                        'Cambio diario > ${fmtNum(alerts.dailyThreshold, decimals: 0)} %',
                        style: const TextStyle(fontSize: 12.5),
                      ),
                    ),
                    Slider(
                ...
                Row(
                  children: [
                    Expanded(
                      child: Text(
                        'Subida de producto > ${fmtNum(alerts.productRiseThreshold, decimals: 0)} %',
                        style: const TextStyle(fontSize: 12.5),
                      ),
                    ),
                    Slider(
                      ...
                      divisions: 9,
                      label:
                          '${alerts.productRiseThreshold.toStringAsFixed(0)} %',
                      onChanged: (v) {
                ...
                Text(
                  'El permiso se gestiona aquí (única fuente, §9.8): '
