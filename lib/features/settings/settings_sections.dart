        ...
        Card(
          child: Padding(
            ...
            child: Column(
              ...
              children: [
                Text(
                  'Tablero configurado para ${country.label}',
                  style: TextStyle(
                    fontSize: 14.5,
                ...
                TextButton(
                  onPressed: () =>
                      store.setSetting('currencyOrder', <String>[]),
  ...
  void _confirmQuitSalary(BuildContext context) {
    showDialog<void>(
      ...
      builder: (ctx) => AlertDialog(
        ...
        content: const Text(
          'Se borra el sueldo guardado (monto, base/variable o rango). '
        ...
        Card(
          child: Padding(
            ...
            child: Column(
              ...
              children: [
                Text(
                  'Cinta de cotizaciones (solo Inicio)',
                  style: TextStyle(
                    fontSize: 13.5,
                ...
                SegmentedChips<int>(
                  ...
                  labelOf: (v) =>
                      v == 90 ? 'Lenta' : (v == 180 ? 'Rápida' : 'Normal'),
                ),
                const SizedBox(height: 10),
                ...
                Container(
                  ...
                  child: Text(
                    switch (store.settings.tickerMode) {
                      'off' => 'Cinta apagada.',
                      'focus' =>
                        'Vista: tus divisas del foco en el orden elegido (1 USD = X).',
                      _ =>
                        'Vista: fuentes protagonistas de ${CountryX.from(store.settings.country).label} + euro.',
                    },
                    style: TextStyle(
                      fontSize: 11.5,
              ...
              children: [
                for (final c in CurrencyX.focusMain) ...[
                  ...
                  if (ctx.rate(store.sourceFor(c)) > 0)
                    Text(
                      'Activa: ${fmtRate(ctx.rate(store.sourceFor(c)))}',
                      style: TextStyle(
                        fontSize: 11,
                        color: scheme.onSurfaceVariant,
                      ),
                ...
                SwitchListTile(
                  ...
                  dense: true,
                  title: const Text(
                    'Refresco automático de tasas',
                    style: TextStyle(fontSize: 13),
                  ),
                  subtitle: const Text(
                    'Consulta el tablero en segundo plano al abrir la app',
...
class _ModuleSource extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final current =
        store.settings.rateSourcesByModule[moduleRateKey(module.code, 'VES')];
    return Padding(
      ...
      child: Row(
        children: [
          ...
          Text(
            current == null
                ? 'Global'
                : (RateSource.of(current)?.label ?? current),
            style: TextStyle(
              fontSize: 12,
            ...
            child: Column(
              ...
              children: [
                ...
                SwitchListTile(
                  ...
                  onChanged: (v) => theme.setDynamicColor(
                    v,
                    context.read<SharedPreferences>(),
                  ),
                  title: const Text(
                    'Color dinámico del sistema (Material You)',
                    style: TextStyle(fontSize: 13),
                  ),
                  subtitle: Text(
        ...
        Card(
          child: Padding(
            ...
            child: Column(
              ...
              children: [
                Text(
                  'Consulta cada región y mide su latencia. Si una falla, la app sigue con las demás.',
                  style: TextStyle(
                    fontSize: 11.5,
                    color: scheme.onSurfaceVariant,
                  ),
                          ...
                          Expanded(
                            child: Column(
                              ...
                              children: [
                                ...
                                Text(
                                  '${r.sources} fuentes · ${r.latencyMs} ms',
                                  style: TextStyle(
                                    fontSize: 11,
                                    color: scheme.onSurfaceVariant,
                                  ),
                                ...
                                if (r.error != null)
                                  Text(
                                    ...
                                    style: TextStyle(
                                      fontSize: 10,
                                      color: ink.neg.withValues(alpha: 0.8),
                                    ),
                                  ),
                              ],
                            ),
