    ...
    return DraggableScrollableSheet(
      ...
      builder: (context, scroll) => Column(children: [
        Padding(
          ...
          child: Row(children: [
            Icon(Icons.notifications_outlined, size: 19, color: Theme.of(context).colorScheme.primary),
            const SizedBox(width: 8),
            Text('Notificaciones',
                style: TextStyle(fontSize: 15.5, fontWeight: FontWeight.w800, color: Theme.of(context).colorScheme.onSurface)),
            if (unread > 0) ...[
              const SizedBox(width: 8),
              Container(
                ...
                child: Text('$unread nueva${unread == 1 ? '' : 's'}',
                    style: TextStyle(fontSize: 11.5, fontWeight: FontWeight.w700, color: Theme.of(context).colorScheme.primary)),
              ),
            ],
            const Spacer(),
            TextButton(
            ...
            TextButton(
              ...
              style: TextButton.styleFrom(foregroundColor: VeColors.of(context).neg),
              child: const Text('Limpiar', style: TextStyle(fontSize: 12.5)),
            ),
          ]),
        ),
          ...
          child: items.isEmpty
              ? Center(
                  child: Column(mainAxisSize: MainAxisSize.min, children: [
                    Icon(Icons.notifications_off_outlined, size: 40, color: Theme.of(context).colorScheme.onSurfaceVariant),
                    const SizedBox(height: 10),
                    const Text('Todo tranquilo', style: TextStyle(fontWeight: FontWeight.w800, fontSize: 15)),
                      ...
                      child: Container(
                        ...
                        child: Row(crossAxisAlignment: CrossAxisAlignment.start, children: [
                          Container(
                            ...
                            child: Icon(_icon(n.kind), size: 15, color: ink),
                          ),
                          ...
                          Expanded(
                            child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                              Row(children: [
                                ...
                                Text(timeAgo(n.at), style: TextStyle(fontSize: 11.5, color: Theme.of(context).colorScheme.onSurfaceVariant)),
                              ]),
                              const SizedBox(height: 2),
                              Text(n.body, style: TextStyle(fontSize: 12.5, height: 1.4, color: Theme.of(context).colorScheme.onSurfaceVariant)),
                              const SizedBox(height: 5),
                              Row(children: [
                                Text(_label(n.kind), style: VeText.labelCaps(9, color: ink, weight: FontWeight.w700)),
                                if (!n.read) ...[
        ...
        SafeArea(
          child: Padding(
            ...
            child: Row(children: [
              Text('Avisos del sistema activos', style: VeText.labelCaps(9.5, color: Theme.of(context).colorScheme.onSurfaceVariant)),
              const Spacer(),
              TextButton(
                onPressed: () {
                ...
                child: const Text('Configurar alertas', style: TextStyle(fontSize: 12.5)),
              ),
            ]),
          ),
        ),
